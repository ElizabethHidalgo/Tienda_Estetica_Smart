...
<head>
    ...
    .btn-crud {
        ...
        margin-right: 0.5rem;
        font-size: 1.2rem; /* Adjust this value to make the text larger */
    }
        ...
        if (carrito.length === 0) {
            ...
            carrito.forEach((item, index) => {
                ...
                <tr>
                    ...
                    <td><input type="number" min="1" value="${item.cantidad}" onchange="actualizarCantidad(${index}, this.value)" style="width: 60px;"></td>
                    <td>
