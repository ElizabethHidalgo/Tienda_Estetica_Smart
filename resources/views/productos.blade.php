    ...
    <nav class="navbar">
        ...
        <div id="mobile-menu" class="lg:hidden hidden">
            <ul class="flex flex-col items-center space-y-4 text-white mt-4">
                ...
                <li class="cart-icon">
                    <a href="#" class="flex items-center hover:text-blue-300"><i
                            class="fas fa-shopping-cart mr-2"></i>Carrito</a>
                </li>
                <li class="user-icon">
                    <a href="{{ route('login') }}" class="hover:text-blue-300"><i
    ...
    <nav class="w-full py-4 border-t border-b bg-gray-100">
        <div class="w-full flex-grow sm:flex sm:items-center sm:w-auto">
            <div
                ...
                <a href="{{ route('productos.index') }}" class="hover:bg-gray-400 rounded py-2 px-4 mx-2">Todas</a>
                <!-- Enlace para mostrar todos los productos -->
                @foreach($categorias as $categoria)
                <a href="{{ route('productos.index', ['categoria' => $categoria->id]) }}"
                    class="hover:bg-gray-400 rounded py-2 px-4 mx-2">{{ $categoria->nombre }}</a>
                @endforeach
            </div>
        </div>
    </nav>
                ...
                <article class="flex flex-col shadow my-4">
                    ...
                    <div class="bg-white flex flex-col justify-start p-6">
                        <a href="#" class="hover:opacity-75">
                            <img src="{{ asset('http://localhost/Tienda_Estetica_Smart/storage/app/public/' . $producto->image_url) }}"
                        ...
                        <p class="text-sm pb-3">
                            <span class="font-semibold hover:text-gray-800">Información:</span>
